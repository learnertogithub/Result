...
var dowload = document.getElementById("dowload");
 if(select==='1year')
 {
  switch (pinbar) {
    case "22280-CM-001":
  imageContainer.innerHTML = '<img id="image" src="CME1styearAudisankaraStudentsList_page-0001.jpg" width="100%" alt="Result Image">';
  dowload.innerHTML='<input type="button" value="Dowload" onclick="dowload()">';
      break;
default :
 error.innerHTML='<p style="color:red">ERROR OCCURED</p>';
 document.write("No Details Fond for"+" "+pinbar);
console.log(pinbar+" "+"No PinNo Found");
 break;
  }
}
else if(select==='4sem')
